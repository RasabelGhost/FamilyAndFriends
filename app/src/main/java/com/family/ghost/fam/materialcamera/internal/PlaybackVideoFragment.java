...
import com.family.ghost.fam.easyvideoplayer.EasyVideoCallback;
import com.family.ghost.fam.easyvideoplayer.EasyVideoPlayer;
...
public class PlaybackVideoFragment extends Fragment
  ...
  public static PlaybackVideoFragment newInstance(
    ...
    args.putBoolean(com.family.ghost.fam.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, allowRetry);
    args.putInt(com.family.ghost.fam.materialcamera.internal.CameraIntentKey.PRIMARY_COLOR, primaryColor);
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    if (getArguments().getBoolean(com.family.ghost.fam.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, true))
